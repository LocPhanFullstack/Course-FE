...
export const BillingScreen = () => {
  ...
  const apiGetListOfTransactions = useAPIGetListOfTransactions();

  const transactionData = apiGetListOfTransactions.data;
  ...
  if (apiGetListOfTransactions.isPending || !isLoaded)
    ...
    <div className="billing">
      <div className="billing__container">
        ...
        <div className="billing__grid">
          {apiGetListOfTransactions.isPending ? (
            <LoadingSpinner />
          ) : (
